...
#define GEGL_OP_META
#define GEGL_OP_NAME     zzoutline
#define GEGL_OP_C_SOURCE zzoutline.c
...
gegl_op_class_init (GeglOpClass *klass)
{
  ...
  gegl_operation_class_set_keys (operation_class,
    ...
    "title",       _("zzoutline"),
    "categories",  "hidden",
    "reference-hash", "29b15222abxa4egh8a7ba97b41d8d4e",
    "description", _("Filter only exist to power GEGL neon border"),
    NULL);
}
